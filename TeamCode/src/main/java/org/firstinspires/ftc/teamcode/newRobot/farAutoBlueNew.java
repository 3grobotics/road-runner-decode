...
@Disabled
@Autonomous(name = "far auto blue new turret bot ", group = "competition")
public class farAutoBlueNew extends LinearOpMode {
...
//(TARGET_RPM * 28) / 60
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /// pickups
            ...
            Action GPP = drive.actionBuilder(new Pose2d(60.5, -5.5, Math.toRadians(-160)))
                    .afterDisp(0, robot.intake())
                    .setTangent(Math.toRadians(-180))
        ...
        Action FLUSH = drive.actionBuilder(new Pose2d(12, -40, Math.toRadians(-90)))
                .setTangent(Math.toRadians(-270))
                ...
                .setTangent(Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(0, -47, Math.toRadians(-90)), Math.toRadians(-90))
                .build();

        Action RETURN_AND_SHOOT = drive.actionBuilder(new Pose2d(0, -47, Math.toRadians(-90)))
                .setTangent(Math.toRadians(-270))

...
@Disabled
@Config
@TeleOp(name = "novus umbra no turret Red", group = "TeleOp")
/* opmode*/
public class newBotTeleNoTurretRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (var == 1 && distanceFromLimelightToGoalInches < 90 && saw24) {
                flywheel1.setVelocity(goodvelclose);
                flywheel2.setVelocity(goodvelclose);
                AIM_OFFSET_DEG_LOCAL = -2;
            } else if (var == 1 && distanceFromLimelightToGoalInches > 90 && saw24) {

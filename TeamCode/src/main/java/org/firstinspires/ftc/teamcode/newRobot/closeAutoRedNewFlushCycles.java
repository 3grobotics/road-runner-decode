...
@Disabled
@Autonomous(name = "close auto red new turret bot flush cycles ", group = "competition")
public class closeAutoRedNewFlushCycles extends LinearOpMode {
...
//(TARGET_RPM * 28) / 60
    ...
    public void runOpMode() throws InterruptedException {
        ...
        gecko = hardwareMap.get(CRServo.class, "gecko");
        ...
        Action PARK = drive.actionBuilder(new Pose2d(0, 54, Math.toRadians(180)))
                .setTangent(Math.toRadians(0))

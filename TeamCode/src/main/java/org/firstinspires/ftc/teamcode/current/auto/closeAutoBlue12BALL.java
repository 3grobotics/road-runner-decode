...
@Autonomous(name = "close Auto Blue 12 Ball", group = "competition")
public class closeAutoBlue12BALL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /* ---- S Selection (Toggle) ---- */
        int S = 1; // 1 = Blue, -1 = Blue
        while (!isStarted() && !isStopRequested()) {
            if (gamepad1.b) S = 1;  // B for Blue
            if (gamepad1.x) S = -1; // X for BLUE

            telemetry.addLine("--- S SELECTION ---");
            telemetry.addData("SELECTED S", S == 1 ? "Blue (B)" : "BLUE (X)");
            telemetry.update();
        }
        ...
        odo.setOffsets(84, -90, DistanceUnit.MM);
        ...
        Action TEST = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(-12, -30, Math.toRadians(-90)), Math.toRadians(-90), adaptiveBrake)
                .setTangent(Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(-12, -53, Math.toRadians(-90)), Math.toRadians(-90), adaptiveBrake)
                ...
                .setTangent(Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(37, -57, Math.toRadians(-90)), Math.toRadians(-90), adaptiveBrakeSlow)
                ...
                .splineToLinearHeading(new Pose2d(20, 60, Math.toRadians(-125)), Math.toRadians(-45))

                .setTangent(Math.toRadians(-270))
                .splineToLinearHeading(new Pose2d(-14.5, 15.5, Math.toRadians(-125)), Math.toRadians(-0), adaptiveBrake)
                .waitSeconds(2)
                .stopAndAdd(robot.fire())
                .waitSeconds(2)
                .stopAndAdd(robot.stopFire())
                ...
                .setTangent(Math.toRadians(-270))
                .splineToLinearHeading(new Pose2d(40, 60, Math.toRadians(-125)), Math.toRadians(-90))
                .setTangent(Math.toRadians(-180))
                .splineToSplineHeading(new Pose2d(16, 60, Math.toRadians(-125)), Math.toRadians(-180))

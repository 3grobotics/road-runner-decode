...
@Autonomous(name = "far Auto blue 1 Flush Cycle 1 Loading Zone", group = "competition")
public class farAutoBlue1FlushCycle1LoadingZone extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action TEST = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(60, -65, Math.toRadians(-100)), Math.toRadians(-90))
                .strafeToLinearHeading(new Vector2d(48, -10 ), Math.toRadians(-155))
                .stopAndAdd( robot.fire())
                .waitSeconds(.2)
                .stopAndAdd( robot.stopFire())
                ...
                .afterDisp(0, robot.intake())
                .setTangent(Math.toRadians(-180))
                .splineToSplineHeading(new Pose2d(60, -60, Math.toRadians(-100)), Math.toRadians(-90))

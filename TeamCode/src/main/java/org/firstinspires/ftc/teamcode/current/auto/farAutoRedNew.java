...
@Autonomous(name = "far auto red new turret bot ", group = "competition")
public class farAutoRedNew extends LinearOpMode {
    ...
    public class Robot {
        ...
        private class flywheelUp implements Action {
            @Override public boolean run(@NonNull TelemetryPacket p) {
                ...
                flywheel1.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(400, 0, 0, 20));
                flywheel2.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(400, 0, 0, 20));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /* ---- Poses & Actions ---- */
        Pose2d initialPose = new Pose2d(68.5, 2 * S, Math.toRadians(180));

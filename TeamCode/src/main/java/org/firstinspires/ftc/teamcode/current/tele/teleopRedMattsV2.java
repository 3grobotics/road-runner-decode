...
@Config
@TeleOp(name = "teleop Red, but matt made it version 2", group = "TeleOp")
public class teleopRedMattsV2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (var == 1 && distToGoal < 105) {
                flywheel1.setVelocity(targetTPS);
                flywheel2.setVelocity(targetTPS);
            } else if (var == 1 && distToGoal > 105){
                flywheel1.setVelocity(targetTPS * 2);
                flywheel2.setVelocity(targetTPS * 2);
            } else {

...
@Autonomous(name = "far Auto blue no spike", group = "competition")
public class farAutoBlueNoSpike extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action TEST = drive.actionBuilder(initialPose)
                ...
                .setTangent(Math.toRadians(-180))
                .splineToLinearHeading(new Pose2d(26, -63, Math.toRadians(-180)), Math.toRadians(-180))

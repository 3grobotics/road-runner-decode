...
@Autonomous(name = "far Auto red no spike", group = "competition")
public class farAutoRedNoSpike extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action TEST = drive.actionBuilder(initialPose)
                ...
                .afterDisp(0, robot.intake())
                .setTangent(Math.toRadians(180))
                .splineToLinearHeading(new Pose2d(60, 63, Math.toRadians(100)), Math.toRadians(90))

                .setTangent(Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(26, 63, Math.toRadians(180)), Math.toRadians(180))

                .setTangent(Math.toRadians(0))
                .splineToLinearHeading(new Pose2d(40, 63, Math.toRadians(155)), Math.toRadians(0))

                .setTangent(Math.toRadians(0))
                .splineToLinearHeading(new Pose2d(48, 10, Math.toRadians(155)), Math.toRadians(270))
                .stopAndAdd( robot.fire())
                .waitSeconds(.2)
                .stopAndAdd( robot.stopFire())
                .waitSeconds(.1)

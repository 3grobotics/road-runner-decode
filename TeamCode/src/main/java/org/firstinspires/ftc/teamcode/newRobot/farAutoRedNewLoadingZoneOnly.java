...
@Disabled
@Autonomous(name = "far auto red new turret bot loading zone only ", group = "competition")
public class farAutoRedNewLoadingZoneOnly extends LinearOpMode {
...
//(TARGET_RPM * 28) / 60
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action LAST_STEP3 = drive.actionBuilder(new Pose2d(60.5, 5.5, Math.toRadians(155)))
                .afterDisp(0, robot.intake())
                .setTangent(Math.toRadians(45))
                .splineToSplineHeading(new Pose2d(67, 55, Math.toRadians(90)), Math.toRadians(90))
                .build();

...
@Disabled
@Autonomous(name = "farAutoBlueCOMP", group = "competition")
public class farAutoBlueCOMP extends LinearOpMode {
    ...
    public class Robot {
        ...
        private class aimRedTag1 implements Action {
            ...
            private static final int    PIPELINE_SETTLE_FRAMES = 6;   // wait a few frames after switching
            ...
            aimRedTag1(MecanumDrive d1) { this.drive1 = d1; }

            @Override public boolean run(@NonNull TelemetryPacket p) {
                if (!inited) {
                    if (limelight != null) limelight.pipelineSwitch(1); // make sure we're on pipeline 0
        ...
        public Action aimRedTag1(MecanumDrive d1) { return new aimRedTag1(d1); }
        ...
        private class aimRedTag2 implements Action {
            ...
            aimRedTag2(MecanumDrive d2) { this.drive2 = d2; }
        ...
        public Action aimRedTag2(MecanumDrive d2) { return new aimRedTag2(d2); }

...
public class farAutoRed extends LinearOpMode {
    ...
    public class Robot {
        ...
        public Action posservo() { return new Robot.posservo(); }
        ...
        public Action posservo2() { return new Robot.posservo2(); }
        ...
        public Action posservo3() { return new Robot.posservo3(); }
        ...
        public Action thing1() { return new Robot.thing1(); }
        ...
        public Action thing2() { return new Robot.thing2(); }
        ...
        public Action thing3() { return new Robot.thing3(); }
        ...
        public Action intake() { return new Robot.intake(); }
        ...
        public Action intake_stop() { return new Robot.intake_stop(); }
        ...
        public Action outtake() { return new Robot.outtake(); }
        ...
        public Action fireM() { return new Robot.fireM(); }
        ...
        public Action fireR() { return new Robot.fireR(); }
        ...
        public Action fireL() { return new Robot.fireL(); }
        ...
        public Action stopM() { return new Robot.stopM(); }
        ...
        public Action stopR() { return new Robot.stopR(); }
        ...
        public Action stopL() { return new Robot.stopL(); }
        ...
        public Action init() { return new Robot.init(); }
        ...
        public Action shootByOrderPreload() { return new Robot.shootByOrderPreload(); }
        ...
        public Action shootByOrderSpike1() { return new Robot.shootByOrderSpike1(); }
        ...
        public Action shootByOrderSpike2() { return new Robot.shootByOrderSpike2(); }
        ...
        public Action aimRedTag(MecanumDrive d) { return new Robot.aimRedTag(d); }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d endOfgospike1 = new Pose2d(40, 43, Math.toRadians(180));
        Pose2d endOfscoreSpike1 = new Pose2d(50, 14, Math.toRadians(340));
        Pose2d endOfgospike2 = new Pose2d(20, 43, Math.toRadians(180));
        Pose2d endOfscoreSpike2 = new Pose2d(50, 14, Math.toRadians(340));
        Pose2d endOfgospike3 = new Pose2d(-8, 43, Math.toRadians(180));
...
//.afterDisp(0, robot.thing3())
        ...
        Action gospike1 = drive.actionBuilder(endOfPreload)
                ...
                .splineToLinearHeading(new Pose2d(60, 43, Math.toRadians(180)), Math.toRadians(90))
                .afterDisp(0, robot.intake())
                .strafeToLinearHeading(new Vector2d(40, 43), Math.toRadians(180))
                .build();
        ...
        Action gospike2 = drive.actionBuilder(endOfscoreSpike1)
                .afterDisp(0, robot.posservo3())
                .setTangent(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(40, 43, Math.toRadians(180)), Math.toRadians(180))

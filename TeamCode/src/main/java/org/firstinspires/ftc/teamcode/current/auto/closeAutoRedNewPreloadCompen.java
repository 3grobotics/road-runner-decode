...
@Autonomous(name = "Competition Auto Red- Turret Bot preload compen", group = "competition")
public class closeAutoRedNewPreloadCompen extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action GPP = drive.actionBuilder(new Pose2d(-14.5, 15.5 * S, Math.toRadians(145 * S)))
                .afterDisp(0, robot.intake())
                .setTangent(Math.toRadians(0 * S))
                .splineToSplineHeading(new Pose2d(30, 20 * S, Math.toRadians(90 * S)), Math.toRadians(90 * S), adaptiveBrake)
                .waitSeconds(.2)
        ...
        Action PARK = drive.actionBuilder(new Pose2d(-14.5, 15.5 * S, Math.toRadians(145 * S)))
                .setTangent(Math.toRadians(90 * S))
                .splineToSplineHeading(new Pose2d(0, 38 * S, Math.toRadians(180 * S)), Math.toRadians(90 * S))
                .build();

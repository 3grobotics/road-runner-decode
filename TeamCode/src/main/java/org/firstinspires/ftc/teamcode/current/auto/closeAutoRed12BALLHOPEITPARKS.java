...
@Autonomous(name = "close Auto Red 12 Ball lets hope it parks", group = "competition")
public class closeAutoRed12BALLHOPEITPARKS extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action TEST = drive.actionBuilder(initialPose)
                ...
                .setTangent(Math.toRadians(315))
                .splineToLinearHeading(new Pose2d(15, 50, Math.toRadians(90)), Math.toRadians(90), adaptiveBrake)
                ...
                .setTangent(Math.toRadians(245))
                .splineToLinearHeading(new Pose2d(-25, 15.5, Math.toRadians(143)), Math.toRadians(245), adaptiveBrake)
                //.waitSeconds(2)
                .stopAndAdd(robot.fire())
                .waitSeconds(2)
                .stopAndAdd(robot.stopFire())
                ...
                .setTangent(Math.toRadians(270))
                .splineToLinearHeading(new Pose2d(-14.5, 15.5, Math.toRadians(140)), Math.toRadians(0), adaptiveBrake)
                .waitSeconds(2)
                .stopAndAdd(robot.fire())
                .waitSeconds(2)
                .stopAndAdd(robot.stopFire())

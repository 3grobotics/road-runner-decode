...
@Disabled
@Autonomous(name = "far auto blue new turret bot loading zone only ", group = "competition")
public class farAutoBlueNewLoadingZoneOnly extends LinearOpMode {
...
//(TARGET_RPM * 28) / 60
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /* ---- traj / action setup ---- */
        Pose2d initialPose = new Pose2d(62, -4, Math.toRadians(-180));
        Pose2d afterPreload = new Pose2d(60.5, -5.5, Math.toRadians(-160));
        ...
        Robot robot = new Robot();
           ...
           Action PRELOAD = drive.actionBuilder(initialPose)
                   ...
                   .splineToLinearHeading(new Pose2d(60.5, -5.5, Math.toRadians(-160)), Math.toRadians(-315))
                   .waitSeconds(1)
        ...
        Action RETURN_AND_SHOOT = drive.actionBuilder(new Pose2d(0, 55, Math.toRadians(90)))
                .setTangent(Math.toRadians(270))
        ...
        Action LAST_STEP = drive.actionBuilder(new Pose2d(60.5, 5.5, Math.toRadians(160)))
                .afterDisp(0, robot.intake())
                .setTangent(Math.toRadians(-90))
        ...
        Action LAST_RETURN = drive.actionBuilder(new Pose2d(67, -55, Math.toRadians(-90)))
                ...
                .splineToSplineHeading(new Pose2d(60.5, -5.5, Math.toRadians(-160)), Math.toRadians(45))
                .stopAndAdd(robot.fire())
                .waitSeconds(2)
                .stopAndAdd(robot.stopFire())
                .build();

        Action LAST_STEP2 = drive.actionBuilder(new Pose2d(60.5, -5.5, Math.toRadians(-160)))
                .afterDisp(0, robot.intake())
                .setTangent(Math.toRadians(-90))
                .splineToSplineHeading(new Pose2d(67, -55, Math.toRadians(-90)), Math.toRadians(-90))
                .build();

        Action LAST_RETURN2 = drive.actionBuilder(new Pose2d(67, -55, Math.toRadians(-90)))
                .setTangent(Math.toRadians(290))
                .splineToSplineHeading(new Pose2d(60.5, -5.5, Math.toRadians(-160)), Math.toRadians(45))
                .stopAndAdd(robot.fire())
                .waitSeconds(2)
        ...
        Action LAST_STEP3 = drive.actionBuilder(new Pose2d(60.5, -5.5, Math.toRadians(-160)))
                .afterDisp(0, robot.intake())
                .setTangent(Math.toRadians(-90))
                .splineToSplineHeading(new Pose2d(67, -55, Math.toRadians(-90)), Math.toRadians(-90))
                .build();

        Action LAST_RETURN3 = drive.actionBuilder(new Pose2d(67, -55, Math.toRadians(-90)))
                .setTangent(Math.toRadians(290))
                .splineToSplineHeading(new Pose2d(60.5, -5.5, Math.toRadians(-160)), Math.toRadians(45))
                .stopAndAdd(robot.fire())
                .waitSeconds(2)
        ...
        Action PARK = drive.actionBuilder(new Pose2d(60.5, -5.5, Math.toRadians(-160)))
                .setTangent(Math.toRadians(-115))
